...
---@field PhysMaterialMask PhysicalMaterialMask
...
---@field RenderTracePhysicalMaterialOutputs PhysicalMaterial[]
...
---@field MaterialDecalResponse integer
...
---@field NumCustomizedUVs integer
...
---@field TranslucencyDirectionalLightingIntensity number
---Scale used to make translucent shadows more or less opaque than the material's actual opacity.
---@field TranslucentShadowDensityScale number
...
---@field bSubstrateRoughnessTracking boolean
...
---@field bUsedWithMaterialCache boolean
...
---@field bRootNodeOverridesDefaultDistortion boolean
...
---@field bUsedWithVolumetricCloud boolean
...
---@field bUsedWithHeterogeneousVolumes boolean
...
---@field bUsedWithStaticMesh boolean
...
---@field bForceCompatibleWithLightFunctionAtlas boolean
...
---This setting has no effect on older mobile devices that do not support high precision.
---@field FloatPrecisionMode integer
...
---@field bAllowFrontLayerTranslucency boolean
...
---@field bAllowTranslucentLocalLightShadow boolean
---Set local light shadow quality received by translucent material.
---@field TranslucentLocalLightShadowQuality number
---Set directional light shadow quality received by translucent material.
---@field TranslucentDirectionalLightShadowQuality number
...
---@field bAllowVariableRateShading boolean
---@field EditorX integer
---@field EditorY integer
---@field EditorPitch integer
---@field EditorYaw integer
...
---@field bIsTranslucencyVelocityFromDepth boolean
...
---@field ResolutionRelativeToInput string
...
---@field bDisablePreExposureScale boolean
...
---@field bUsedWithNeuralNetworks boolean
...
---@field StencilCompare integer
---@field StencilRefValue integer
---Set by reference object cannot be modified.
---@field NeuralProfileId any
---@field RefractionMode integer
...
---@field RefractionMethod integer
---Controls whether refraction takes into account the material surface coverage, or not.
---@field RefractionCoverageMode integer
---Controls whether refraction takes into account the material surface coverage, or not.
---@field PixelDepthOffsetMode integer
...
---@field BlendablePriority integer
...
---@field RefractionDepthBias number
...
---@field bAlwaysEvaluateWorldPositionOffset boolean
