...
local ActorTickFunction = {}

--- Constructor
---@return ActorTickFunction
...
function ActorTickFunction.new(TickGroup, EndTickGroup, bTickEvenWhenPaused, bCanEverTick, bStartWithTickEnabled, bAllowTickOnDedicatedServer, TickInterval)
    local self = {}
