...
local ActorComponentTickFunction = {}

--- Constructor
---@return ActorComponentTickFunction
...
function ActorComponentTickFunction.new(TickGroup, EndTickGroup, bTickEvenWhenPaused, bCanEverTick, bStartWithTickEnabled, bAllowTickOnDedicatedServer, TickInterval)
    local self = {}
