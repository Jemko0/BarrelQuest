...
---@field ProjectionLinearAlpha number
...
---@field ProjectionAngularAlpha number
...
---@field ShockPropagationAlpha number
...
---@field LinearPlasticityThreshold number
...
---@field AngularPlasticityThreshold number
---[Chaos Only] Colliison transfer on parent from the joints child. Range is 0.0-MAX
---@field ContactTransferScale number
---@field LinearLimit LinearConstraint
---@field ConeLimit ConeConstraint
---@field TwistLimit TwistConstraint
...
---@field bEnableShockPropagation boolean
...
---@field bEnableMassConditioning boolean
...
---@field LinearDrive LinearDriveConstraint
---@field AngularDrive AngularDriveConstraint
