...
---@field MaskB integer
---@field MaskA integer
local ShadingModelMaterialInput = {}

--- Constructor
---@return ShadingModelMaterialInput
...
---@param MaskB integer
---@param MaskA integer
function ShadingModelMaterialInput.new(Expression, OutputIndex, InputName, Mask, MaskR, MaskG, MaskB, MaskA)
    local self = {}
